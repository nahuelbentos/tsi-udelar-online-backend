...
namespace Perifericos.Mail
{
  public class MailGenerator : IMailGenerator
  {
    public bool ResetPassword(string to, string subject,  string token, Usuario usuario)
    {
          ...
          mail += $"<h4>Link:  <a href='http://localhost:4200/home/forgot-password?fromEmail=true&token={token}&email={usuario.Email}' target='_blank' rel='noopener noreferrer'>ir a UdelarOnline</a>.</h4>";
          mail += "<br><br><br><br><br>";
